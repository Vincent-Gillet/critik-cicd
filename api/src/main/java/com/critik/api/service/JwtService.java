...
// Les claims sont typiquement : username, date d’expiration, rôles, etc.
    ...
    public Optional<UtilisateurDTO> getUserByAccessToken(String accessToken) {
        try {
            String username = extractUsername(accessToken);

            if (username != null) {
                Optional<Utilisateur> utilisateur = utilisateurService.trouverParEmailUtilisateur(username);

                return utilisateur.map(u -> {
