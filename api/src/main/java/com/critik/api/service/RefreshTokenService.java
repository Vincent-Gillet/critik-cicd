...
import com.critik.api.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    public RefreshToken generateRefreshTokenBdd(Utilisateur utilisateur) {
        String token = generateRefreshToken(utilisateur.getEmail());
...
// Les claims sont typiquement : username, date d’expiration, rôles, etc.
    ...
    public Optional<UtilisateurDTO> getUserByRefreshToken(String token) {
        System.out.println("Looking for token: " + token);

        Optional<UtilisateurDTO> result = refreshTokenRepository.findByIdRefreshToken(token)
